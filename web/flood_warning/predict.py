...
CKPT_DIR = REPO / 'web' / 'flood_warning' / 'checkpoints'
OUT_PATH = REPO / 'web' / 'models' / 'dmv-cnn-12h' / 'preds.json'
...
def backtest_gauge(gauge_id: str, model, scaler, cfg, days_back: int = 30,
    ...
    """
    from pathlib import Path
    parquet = Path('/Users/pluto/Archive/dmv-flood-data') / gauge_id / 'hourly.parquet'
    if parquet.exists():
